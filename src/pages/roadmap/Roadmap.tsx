...
const ITEMS: Item[] = [
   ...
   { id: "media-repair",   pro: true,  isTab: true, next: true,                 icon: <FaWrench size={14} /> },
   { id: "quick-check",    pro: false, delivered: { version: "v1.4.8" },        icon: <FaBolt size={14} /> },
   { id: "map-plus",       pro: true,                                           icon: <FaFilePdf size={15} /> },
   { id: "media-lab",      pro: false, isTab: true, delivered: { version: "v1.4.9" }, icon: <FaFlask size={14} /> },
   { id: "vvprogressiv",   pro: true,                                           icon: <FaStream size={14} /> },
   { id: "kompatibilitaet", pro: false, delivered: { version: "v1.4.9" },        icon: <FaCheckCircle size={14} /> },
   { id: "media-stapel",   pro: true,  isTab: true, next: true,                 icon: <FaCopy size={14} /> },
   { id: "macos",          pro: false,                                          icon: <FaApple size={15} /> },
   { id: "statistik",      pro: true,                                           icon: <FaChartBar size={15} /> },
   { id: "media-test",     pro: false, delivered: { version: "v1.4.9" },        icon: <FaDesktop size={15} /> },
